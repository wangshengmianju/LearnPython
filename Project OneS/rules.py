...
class HeadingRule(Rule):
    """
    A heading is a single line that is at most 79 characters and that doesn't end with a colon.
    """
    type = 'heading'
...
class ListItemRule(Rule):
    """
    A list item is a paragrph that begins with a hyphen. As part of the formatting, he hyphen is removed.
    """
    type = 'listitem'
    def condition(self, block):
        return block[0] == '-'
